  ...
  render() {
    return (
      <div>
        <main id="pattern-pg">
          <header>
            <button className="w3-button w3-ripple pattern-nav-button"><a><i className="fas fa-tasks"></i> Create a New Pattern</a></button>
          ...
          <input type={Text} placeholder="Enter your notes here..." />
          <br />
